    ...
    <main>
        ...
        <div class="product-grid">
            <?php foreach ($resultado as $row) { ?>
                ...
                ?>
                <div class="product">
                    <a href="detalles-producto.php?id=<?php echo $row['id_aro']; ?>&tipo=<?php echo $row['id_tipo_producto']; ?>&token=<?php echo hash_hmac('sha1', $row['id_aro'], KEY_TOKEN); ?>"><img src="<?php echo $image; ?>"></a>
